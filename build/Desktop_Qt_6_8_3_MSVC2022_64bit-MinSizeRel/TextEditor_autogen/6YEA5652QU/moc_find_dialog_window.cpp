/****************************************************************************
** Meta object code from reading C++ file 'find_dialog_window.h'
**
...
#include "../../../../include/find_dialog_window.h"
...
#error "The header file 'find_dialog_window.h' doesn't include <QObject>."
...
void FindDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->findNext((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2]))); break;
        case 1: _t->findPrev((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FindDialog::*)(const QString & , bool );
        ...
        {
            using _q_method_type = void (FindDialog::*)(const QString & , bool );
            if (_q_method_type _q_method = &FindDialog::findPrev; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FindDialog::findNext(const QString & _t1, bool _t2)
{
...
// SIGNAL 1
void FindDialog::findPrev(const QString & _t1, bool _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
